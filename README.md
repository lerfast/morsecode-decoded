...
# 📖 Morse Decoder <a name="about-project"></a>
 This project is project designed to build familiarity  with the ruby programming language it teaches variables and method usage in its basic form.  
...
```sh
  cd folder
  git clone git@github.com:lerfast/morsecode-decoded.git
```
### Install
